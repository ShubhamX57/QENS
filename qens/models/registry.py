...
_REGISTRY["translation_only"] = ForwardModel(
...
_REGISTRY["isotropic_rotor"] = ForwardModel(
    name="isotropic_rotor",
...
_REGISTRY["anisotropic_rotor"] = ForwardModel(
...
def register_model(
    ...
    *,
    ...
    if name in _REGISTRY and not overwrite:
        raise KeyError(
            f"model {name!r} already registered; pass overwrite=True to replace"
        )
    fm = ForwardModel(
        name=name,
